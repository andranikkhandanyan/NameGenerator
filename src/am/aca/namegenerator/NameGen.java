...
public class NameGen {
     ...
     */
    private static final Supplier<String> ADJECTIVES = () -> randomFromList(Arrays.asList(Adjectives.VALUES));
    private static final Supplier<String> NOUNS = () -> randomFromList(Arrays.asList(Nouns.VALUES));
